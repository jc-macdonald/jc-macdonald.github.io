...
The design eliminates the bookkeeping errors that arise when manually implementing large structured models (e.g., age-structured epidemic models, trait-structured ecological models, or reaction-diffusion systems with dozens of state variables) and reduces the barrier to simulation of complex multi-physics systems.
